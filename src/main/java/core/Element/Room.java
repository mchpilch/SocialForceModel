...
public class Room {
    ...
    public Room(float posX, float posY, float width, float height, World world, String name,  float scale, float moveRoomX, float moveRoomY) {
        this.name = name;
        posX = scale*(posX+moveRoomX);
        posY = scale*(posY+moveRoomY);
        width = scale*width;
        height = scale*height;
